...
{
	clk->rate *= pfc_divisors[__raw_readl(FRQMR1) & 0x000f];
}
...
{
	int idx = (__raw_readl(FRQMR1) & 0x000f);
...
{
	int idx = ((__raw_readl(FRQMR1) >> 16) & 0x000f);
...
{
	int idx = ((__raw_readl(FRQMR1) >> 28) & 0x0003);
...
{
	int idx = ((__raw_readl(FRQMR1) >> 20) & 0x0003);
...
{
	int idx = ((__raw_readl(FRQMR1) >> 12) & 0x0003);
